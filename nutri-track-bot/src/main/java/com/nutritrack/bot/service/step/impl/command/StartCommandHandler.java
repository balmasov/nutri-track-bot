...
import static com.nutritrack.bot.config.MessageKey.START_COMMAND_MSG;
...
public class StartCommandHandler implements CommandHandler {
    ...
    @Inject
    public StartCommandHandler(KeyboardService keyboardService) {
    ...
    public SendMessage handle(User user, CustomUpdate update) {
        ...
        return keyboardService.createCookingOrEatingKeyboard(update, START_COMMAND_MSG);
    }
}
